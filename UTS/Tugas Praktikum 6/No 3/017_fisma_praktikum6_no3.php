...
require_once '017_fisma_praktikum6_abstractno3.php';
require_once '017_fisma_praktikum6_interfaceno3.php';
...
$manusia = new Homosapiens('Bryan Bramasta');
$airplane2 = new Airplane2(20000, 'Garuda Indonesia');
